...
public class StartupServlet extends GenericServlet {
    ...
    private static final String CRON_EXPRESSION_2 = "0 0 10 ? * MON,TUES,WED,THRUS,FRI,SAT,SUN"; // 10AM (GMT) on ALL week days
    ...
    public void init(ServletConfig servletConfig) throws ServletException {
        ...
        try {
            ...
            JobDetail jobDetail2 = new JobDetail("MyJob2", "MyJobGroup", com.newsbot.bots.facebook.SendNewsWorker.class);
            ...
            JobDetail jobDetail3 = new JobDetail("MyJob3", "MyJobGroup", com.newsbot.bots.slack.SendNewsWorker.class);
            ...
            com.newsbot.bots.facebook.NewsServlet ns1 = new com.newsbot.bots.facebook.NewsServlet();
            com.newsbot.bots.slack.NewsServlet ns2 = new com.newsbot.bots.slack.NewsServlet();
